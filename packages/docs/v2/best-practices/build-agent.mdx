...
The above example is a Claude agent that uses Stagehand to control a browser. [Multimodal tool calling](https://sdk.vercel.ai/docs/ai-sdk-core/tools-and-tool-calling#multi-modal-tool-results) is supported in Claude Sonnet 4 and newer models. 
